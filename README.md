...
<p align="center">
  <img width="600" height="200" src="https://latex.codecogs.com/gif.latex?\dpi{200}&space;\large&space;\vec{x}_{k&plus;1}&space;=&space;\Phi_k&space;\vec{x}_{k}&space;&plus;&space;\Gamma_k&space;\vec{w}_k">
</p>
